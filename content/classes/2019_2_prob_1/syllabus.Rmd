...
- Aulas : 2a, 16h-18h; e 4a, 8h-10h

- Instruções para o envio de e-mails: 
Por favor adicione ``[Probabilidade 1]'' ao 
...
- Descrever incerteza por meio de variáveis aleatórias.
- Resumir incerteza por meio de momentos de variáveis aleatórias.
- Quantificar a incerteza em processos de contagem e de espera.
- Obter a distribuição de transformações de variáveis aleatórias.

<br/>

### Pré-requisitos

- Cálculo 1 e Fundamentos de Probabilidade.
...
```{r echo = FALSE, message = FALSE}
library(magrittr)
keys = c("Participação", "Média dos testes", "Prova")
values = c("0.05", "0.65", "0.3")
